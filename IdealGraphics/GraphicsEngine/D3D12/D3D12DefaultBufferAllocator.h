...
namespace Ideal
{
	...
	public:
		D3D12DefaultBufferAllocator(ComPtr<ID3D12Device> InDevice);
		
		void AllocateDefaultResource(D3D12_HEAP_TYPE InHeapType, D3D12_HEAP_FLAGS InHeapFlags, const D3D12_RESOURCE_DESC& InResourceDesc, D3D12_RESOURCE_STATES InInitialResourceState, ED3D12ResourceStateMode InResourceStateMode, D3D12_RESOURCE_STATES InCreateState, D3D12ResourceLocation& ResourceLocation, uint32 Alignment);
