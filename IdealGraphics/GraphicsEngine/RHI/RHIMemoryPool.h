...
namespace Ideal { class RHIPoolAllocator; }
...
namespace Ideal
{
	...
	public:
		...
		void TryClear(const RHIContext& Context, RHIPoolAllocator* InAllocator, uint32 InMaxCopySize, uint32& CopySize, const std::vector<RHIMemoryPool*>& InTargetPools);
